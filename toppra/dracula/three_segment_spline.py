...
def ThreeSegmentSpline(Ps, Vs, As, Pe, Ve, Ae, fin=None, Jmax = 0.5, debugging=False):
    ...
    V3 = np.array(Ve)
    A3 = np.array(Ae)
    J0 = (A3*o*(n + o) - A0*(3*m**2 + n*(n + o) + 2*m*(2*n + o)) - 2*(3*P0 - 3*P3 + 3*m*V0 + 2*n*V0 + o*V0 + n*V3 + 2*o*V3))/(m*(m + n)*(m + n + o)) 
    P1 = (A0*m**2)/2 + (J0*m**3)/6 + P0 + m*V0 
    V1 = A0*m + (J0*m**2)/2 + V0 
    A1 = A0 + J0*m 
    J1 = -((A3*o**2 + A1*(3*n**2 + 6*n*o + 2*o**2) + 6*(P1 - P3 + (n + o)*V1))/(n*(n**2 + 3*n*o + 2*o**2))) 
